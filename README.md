...
Inspect Actor details, then use generic `call-actor` with build `0.6.41` for
LinkedIn or `1.0.10` for EURAXESS. Confirm terminal success, verify the exact
...
| --- | --- | --- | --- |
| 1 | [n8n](integrations/n8n/README.md) | Schedule -> Actor -> flatten -> Google Sheets append-or-update | Exact LinkedIn `0.6.41` and EURAXESS `1.0.10` pins; all current input fields supported |
| 2 | [Make](integrations/make/README.md) | Completed Actor run -> flatten -> Google Sheets upsert | Task-owned complete inputs; exact LinkedIn `0.6.41` and EURAXESS `1.0.10` pins required |
