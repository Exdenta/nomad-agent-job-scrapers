...
Inspect Actor details, then use generic `call-actor` with build `0.6.40` for
...
| --- | --- | --- | --- |
| 1 | [n8n](integrations/n8n/README.md) | Schedule -> Actor -> flatten -> Google Sheets append-or-update | Exact LinkedIn `0.6.40` and EURAXESS `1.0.9` pins; all current input fields supported |
| 2 | [Make](integrations/make/README.md) | Completed Actor run -> flatten -> Google Sheets upsert | Task-owned complete inputs; exact LinkedIn `0.6.40` and EURAXESS `1.0.9` pins required |
