...
- `filters` uses the shared [normalized filter grammar](../.agents/skills/linkedin-enrich-translate-normalize-scraper/references/input-contract.md#filters).
...
The [canonical schema](../integrations/shared/nomad-agent-job-v1.schema.json)
describes common fields; the [YC v2 schema](../integrations/shared/ycombinator-v2.schema.json)
...
The [Agent Skill](../.agents/skills/ycombinator-enrich-translate-normalize-scraper/SKILL.md) supports source-specific
