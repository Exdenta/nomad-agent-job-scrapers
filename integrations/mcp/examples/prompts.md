...
nomad-agent/linkedin-enrich-translate-normalize-scraper at exact build 1.0.2.
...
```text
Use generic call-actor for
nomad-agent/euraxess-enrich-translate-normalize-scraper at exact build 1.0.28.
