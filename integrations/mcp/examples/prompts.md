...
nomad-agent/linkedin-enrich-translate-normalize-scraper at exact build 0.6.39.
...
nomad-agent-run-summary-v3. If a usable partial outcome recommends retry,
...
```text
Use generic call-actor for
nomad-agent/euraxess-enrich-translate-normalize-scraper at exact build 1.0.9.
